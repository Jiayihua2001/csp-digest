...
## Why it matters
Packora introduces a flow-based generative model jointly predicting coordinates and lattice from molecular graphs, conditionable on conformers/stereochemistry/space-group, with systematic architecture/scaling design and separated generation-versus-ranking evaluation.
