...
## Why it matters
Packora introduces a flow-based generative model jointly predicting atoms and lattice from molecular graphs, conditioning flexibly on conformers, stereochemistry, and space groups, with systematic architecture/scaling ablations.
