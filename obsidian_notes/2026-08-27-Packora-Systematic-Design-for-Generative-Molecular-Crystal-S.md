...
## Why it matters
Packora introduces a flow-based generative model that jointly predicts atomic coordinates and lattice from molecular graphs, conditioning flexibly on conformers, stereochemistry, and space groups, with a systematic architecture/training study outperforming prior generators and rankers.
