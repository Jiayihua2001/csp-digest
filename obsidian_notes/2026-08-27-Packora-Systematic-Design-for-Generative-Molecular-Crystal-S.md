...
## Why it matters
Packora introduces a single flow-based generative model that jointly predicts atomic coordinates and lattice from molecular graphs, flexibly conditioning on conformers, stereochemistry, and space group for multi-component/organometallic CSP.
