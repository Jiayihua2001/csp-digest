...
## Why it matters
Packora introduces a flow-based generative model jointly predicting atoms and lattice from molecular graphs, conditionable on conformers/stereochemistry/space-group, with systematic architecture-training-scaling design outperforming baselines on decoupled generation/ranking benchm
