...
## Why it matters
Packora introduces a flow-based generative CSP model jointly predicting coordinates and lattice from molecular graphs, supporting multi-component/organometallic crystals with flexible conditioning, plus a systematic architecture/training design study and separated generation-versus-ranking eva
