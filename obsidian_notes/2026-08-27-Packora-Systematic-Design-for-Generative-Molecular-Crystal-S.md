...
## Why it matters
Packora introduces a flow-based generative CSP model with cacheable pairwise reasoning and flexible conditioning (conformers, stereochemistry, space group), jointly predicting coordinates and lattice for multi-component/organometallic crystals.
