...
## Why it matters
Packora introduces a flow-based generative CSP model that jointly predicts atomic coordinates and lattice from molecular graphs, flexibly conditioning on conformers, stereochemistry, or space group within one architecture.
