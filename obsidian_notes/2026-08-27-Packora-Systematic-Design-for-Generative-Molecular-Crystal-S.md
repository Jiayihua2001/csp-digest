...
## Why it matters
Packora introduces a flow-based generative model jointly predicting atoms and lattice from molecular graphs, supporting multi-component/organometallic crystals with flexible conditioning, plus a systematic architecture/scaling study outperforming baselines.
