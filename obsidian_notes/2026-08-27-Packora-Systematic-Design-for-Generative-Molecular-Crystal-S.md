...
## Why it matters
Packora introduces a flow-based generative model that jointly predicts atomic coordinates and lattice from molecular graphs, supporting multi-component/organometallic crystals with flexible conditioning, plus a systematic architecture-scaling study outperforming prior CSP generators.
