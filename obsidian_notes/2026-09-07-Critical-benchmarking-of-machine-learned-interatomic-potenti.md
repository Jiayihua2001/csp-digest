...
**Scores:** relevance 80 / significance 12
**Field:** [[ML-potential]] [[lattice-energy]] [[benchmark]]

## Why it matters
Introduces a continually pretrained AIMNet2(2025) model plus a 21-dataset noncovalent-interaction benchmark showing it rivals larger MACE-OMol/UMA-S-OMol despite far smaller size, while exposing pathological failures on supramol
