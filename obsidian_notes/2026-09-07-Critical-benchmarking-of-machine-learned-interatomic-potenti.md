...
## Why it matters
Systematically benchmarks five MLIPs (including a newly curated AIMNet2(2025) variant) across 21 CCSD(T)/CBS-level noncovalent interaction datasets, exposing pathological supramolecular failure cases and confounding evaluation factors.
