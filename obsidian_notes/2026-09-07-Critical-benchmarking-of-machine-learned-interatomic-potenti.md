...
## Why it matters
Systematically benchmarks five MLIPs across 21 CCSD(T)/CBS-referenced NCI datasets, showing continual pretraining (AIMNet2-2025 with 3.8M added structures) rivals far larger models while exposing pathological supramolecular fail
