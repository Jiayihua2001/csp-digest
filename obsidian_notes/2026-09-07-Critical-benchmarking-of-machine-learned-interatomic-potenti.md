...
## Why it matters
Systematically benchmarks five MLIPs across twenty-one noncovalent-interaction datasets, introducing AIMNet2(2025), a continually pretrained model showing broad accuracy gains yet persistent supramolecular-complex failures.
