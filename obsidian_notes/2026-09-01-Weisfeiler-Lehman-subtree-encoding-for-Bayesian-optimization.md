...
## Why it matters
Introduces the Weisfeiler-Lehman subtree kernel as an explicit-feature graph descriptor for BO of atomic configurations, cutting BC$_2$N ground-state search evaluations from 280±122 (one-hot) to 108±5.
