...
## Why it matters
Introduces a Weisfeiler-Lehman subtree kernel—expressed as explicit L²-normalized histogram features—as a graph-based descriptor for Bayesian optimization, cutting BC₂N ground-state search evaluations versus one-hot encoding.
