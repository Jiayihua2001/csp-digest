...
## Why it matters
Introduces a Weisfeiler-Lehman subtree kernel—expressed as explicit normalized histogram features—as a drop-in graph-based descriptor for Bayesian optimization, cutting BC2N ground-state search evaluations from 280±122 to 108±5
