...
## Why it matters
Introduces the Weisfeiler-Lehman subtree kernel as an explicit-feature descriptor for BO-based atomic configuration search, cutting evaluations ~2.6× versus one-hot encoding in a BC2N benchmark.
