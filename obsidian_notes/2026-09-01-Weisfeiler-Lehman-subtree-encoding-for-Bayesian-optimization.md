...
## Why it matters
Introduces the Weisfeiler-Lehman subtree kernel as an explicit, drop-in histogram descriptor for Bayesian optimization, cutting BC2N ground-state search evaluations roughly 2.6x versus one-hot encoding.
