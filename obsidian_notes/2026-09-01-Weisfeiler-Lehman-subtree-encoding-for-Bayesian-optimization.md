...
## Why it matters
Introduces the Weisfeiler-Lehman subtree kernel as an explicit-feature descriptor for Bayesian optimization of atomic configurations, cutting BC2N ground-state search evaluations from 280±122 to 108±5 versus one-hot encoding.
