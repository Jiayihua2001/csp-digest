...
**Authors:** [[Akira Kusaba]], [[Tatoshi Yonemori]], [[Tetsuji Kuboyama]]
**Link:** https://arxiv.org/abs/2609.00953v1
**Scores:** relevance 70 / significance 0
**Field:** [[ML-potential]] [[benchmark]]

## Why it matters
Introduces the Weisfeiler-Lehman subtree kernel as an explicit-feature graph descriptor for Bayesian-optimization atomic configuration search, cutting BC2N ground-state discovery evaluations roughly threefold versus one-hot encoding.
