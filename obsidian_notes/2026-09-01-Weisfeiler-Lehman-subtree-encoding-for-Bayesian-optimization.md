...
## Why it matters
Introduces the Weisfeiler-Lehman subtree kernel as an explicit graph-based descriptor for Bayesian optimization, cutting BC2N ground-state search evaluations by roughly half versus one-hot encoding.
