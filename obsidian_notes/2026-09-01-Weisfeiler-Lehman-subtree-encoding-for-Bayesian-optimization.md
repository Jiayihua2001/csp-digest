...
## Why it matters
Introducing the Weisfeiler-Lehman subtree kernel as an explicit-feature descriptor for Bayesian optimization of atomic configurations, cutting BC2N ground-state search evaluations nearly threefold versus one-hot encoding.
