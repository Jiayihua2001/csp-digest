...
## Why it matters
Introduces CE-ETNet, coupling an equivariant Transformer with a differentiable charge-equilibration module to predict electronegativities and long-range Coulomb energy, cutting energy/force MAE ~8% over prior local potentials.
