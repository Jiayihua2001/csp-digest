...
## Why it matters
Introduces CE-ETNet, coupling an equivariant Transformer with a differentiable charge-equilibration module to explicitly model long-range Coulomb interactions, cutting energy/force MAE ~8% across QM9, rMD17, and tmQM_wB97M
