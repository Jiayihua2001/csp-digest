...
## Why it matters
Introduces CE-ETNet, coupling an equivariant Transformer with a differentiable charge-equilibration layer to embed long-range Coulomb interactions, cutting energy/force MAE ~8% across QM9, MD17, tmQM_wB97MV.
