...
## Why it matters
Introduces CE-ETNet, coupling an equivariant Transformer encoder with a differentiable charge-equilibration layer to inject long-range Coulomb physics, cutting energy/force MAE ~8% across QM9, rMD17, and tmQM_wB97M
