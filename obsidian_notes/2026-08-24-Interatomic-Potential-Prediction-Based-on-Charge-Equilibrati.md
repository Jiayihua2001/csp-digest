...
## Why it matters
Introduces CE-ETNet, an equivariant Transformer potential coupling learned atomic electronegativities with a differentiable charge-equilibration solver to explicitly model long-range Coulomb interactions, cutting energy/force MAE ~8% across QM9, rM
