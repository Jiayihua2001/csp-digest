...
## Why it matters
CE-ETNet couples an equivariant Transformer encoder with a differentiable charge-equilibration layer enforcing total-charge conservation, explicitly embedding long-range Coulomb physics to cut energy/force MAE ~8% across QM9, rMD17, and
