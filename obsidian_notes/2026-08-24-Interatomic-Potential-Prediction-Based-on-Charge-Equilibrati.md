...
## Why it matters
Introduces CE-ETNet, coupling an equivariant Transformer with a differentiable charge-equilibration module for long-range Coulomb energetics, cutting energy/force MAE ~8% versus prior local ML potentials.
