...
## Why it matters
Establishes the first rigorous multi-layer completeness theorem proving that L-layer message passing with small per-layer cutoffs matches full L-hop neighborhood expressiveness, certifying universal approximation for DPA3 and CHGNet potentials.
