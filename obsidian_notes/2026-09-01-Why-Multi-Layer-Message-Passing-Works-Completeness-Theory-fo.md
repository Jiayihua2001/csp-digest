...
## Why it matters
Establishes the first completeness theorem proving multi-layer, small-cutoff message passing GNN potentials match full-neighborhood expressivity, validating DPA3/CHGNet's universal approximation.
