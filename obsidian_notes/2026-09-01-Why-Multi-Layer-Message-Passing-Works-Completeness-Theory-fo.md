...
## Why it matters
Introduces a multi-layer completeness theorem proving that L-layer sparse cutoff-based message passing matches full L-hop neighborhood expressiveness under generic overlap/connectivity conditions, rigorously justifying small-cutoff GNN interatomic potentials
