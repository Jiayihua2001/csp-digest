...
## Why it matters
Establishes the first rigorous multi-layer completeness theorem proving sparse, cutoff-limited message-passing GNNs (e.g., DPA3, CHGNet) achieve full L-hop expressivity, justifying universal approximation of potential energy surfaces.
