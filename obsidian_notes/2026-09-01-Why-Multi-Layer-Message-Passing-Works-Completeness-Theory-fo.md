...
## Why it matters
Establishes the first multi-layer completeness theorem proving that L-layer, cutoff-limited message passing matches full L-hop neighborhood expressivity, extending universal approximation to DPA3 and CHGNet.
