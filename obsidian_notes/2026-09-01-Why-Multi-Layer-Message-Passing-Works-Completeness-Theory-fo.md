...
## Why it matters
Provides the first rigorous multi-layer completeness proof showing that sparse, cutoff-limited message-passing GNNs (e.g., DPA3, CHGNet) achieve full L-hop representational power and universal approximation for interatomic potentials.
