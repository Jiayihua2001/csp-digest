...
## Why it matters
Establishes the first completeness theorem proving multi-layer, sparse-cutoff message-passing GNN interatomic potentials match full L-hop neighborhood expressivity, theoretically justifying DPA3/CHGNet's universal approximation.
