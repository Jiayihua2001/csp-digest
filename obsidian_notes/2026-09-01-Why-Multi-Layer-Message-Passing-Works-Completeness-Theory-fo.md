...
**Link:** https://arxiv.org/abs/2609.00528v1
**Scores:** relevance 70 / significance 0
**Field:** [[ML-potential]]

## Why it matters
Provides the first rigorous multi-layer completeness theorem proving that stacked, small-cutoff message-passing GNNs match full L-hop neighborhood expressivity, establishing universal approximation for DPA3 and CHGNet potentials.
