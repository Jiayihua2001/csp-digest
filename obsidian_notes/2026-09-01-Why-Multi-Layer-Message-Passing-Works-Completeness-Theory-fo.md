...
## Why it matters
Provides the first completeness proof that multi-layer, sparse cutoff-based message passing matches full L-hop neighborhood expressivity, establishing universal approximation for DPA3 and CHGNet.
