...
## Why it matters
Introduces a multi-layer completeness theorem proving that sparse, cutoff-limited L-layer message passing matches full L-hop neighborhood expressiveness, rigorously justifying universal approximation for real GNN interatomic potentials like DPA3 and CHGN
