...
## Why it matters
Introduces two Hessian-informed data-augmentation schemes—isotropic (UniAug) and normal-mode-weighted (ModeAug) displacement via Taylor expansion—that inject curvature information into MLIP training without architectural changes or higher-order backpropagation
