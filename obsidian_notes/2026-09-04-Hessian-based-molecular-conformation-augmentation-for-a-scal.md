...
## Why it matters
Introduces two plug-and-play, Hessian-derived data-augmentation schemes (UniAug, ModeAug) using Taylor-expanded atomic displacements to inject curvature information into MLIP training without architectural changes or higher-order backpropagation.
