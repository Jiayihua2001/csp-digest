...
## Why it matters
Repurposes universal MLIPs not as direct predictors but as configuration-space samplers—using their PES-softening bias to generate diverse trajectories subsequently DFT-relabeled for accurate, material-specific fine-tuned potentials.
