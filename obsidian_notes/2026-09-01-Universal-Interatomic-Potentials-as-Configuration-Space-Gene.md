...
## Why it matters
Repurposes universal MLIPs as configuration-space samplers—exploiting their PES-softening bias to generate diverse trajectories—for one-shot/iterative DFT relabeling into accurate, material-specific fine-tuned potentials.
