...
## Why it matters
Repurposes universal MLIPs solely as configuration-space samplers—exploiting their PES-softening bias to generate diverse trajectories—then relabels with DFT for one-shot/iterative fine-tuning into accurate material-specific potentials.
