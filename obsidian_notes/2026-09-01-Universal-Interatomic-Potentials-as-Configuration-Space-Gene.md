...
## Why it matters
Repurposes universal MLIPs' known potential-energy-surface softening as a deliberate configuration-space sampler, driving DFT-relabeled fine-tuning to yield accurate material-specific models for reactive/transport processes universal MLIPs miss zero-shot.
