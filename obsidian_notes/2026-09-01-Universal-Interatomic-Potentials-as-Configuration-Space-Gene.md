...
## Why it matters
Repurposes universal MLIPs' PES-softening bias as an efficient configuration-sampling tool to generate diverse trajectories for DFT relabeling, enabling accurate one-shot/iterative fine-tuning of material-specific potentials for reactive/transport processes
