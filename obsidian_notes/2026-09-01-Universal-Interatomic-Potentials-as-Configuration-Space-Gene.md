...
## Why it matters
Repurposes universal MLIPs not as direct predictors but as configuration-space samplers—exploiting their PES-softening bias—to generate DFT-relabeled datasets for one-shot/iterative fine-tuning of accurate material-specific potentials.
