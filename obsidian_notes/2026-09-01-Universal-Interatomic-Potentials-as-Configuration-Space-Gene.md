...
## Why it matters
Using universal MLIPs solely as fast configuration samplers—then relabeling with DFT to train/fine-tune material-specific models—turns their known potential-energy-surface softening into a sampling advantage rather than an accuracy liability.
