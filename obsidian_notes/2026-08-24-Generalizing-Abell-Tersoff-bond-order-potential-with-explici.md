...
**Link:** https://arxiv.org/abs/2608.22933v3
**Scores:** relevance 70 / significance 0
**Field:** [[ML-potential]]

## Why it matters
Introduces a semiparametric bond-order potential generalizing Abell–Tersoff with explicit high-order many-body terms, achieving MLIP-level interpolation while substantially improving extrapolation to unseen, high-pressure/temperature configurations.
