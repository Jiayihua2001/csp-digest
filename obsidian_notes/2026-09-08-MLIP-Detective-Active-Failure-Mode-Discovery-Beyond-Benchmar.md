...
## Why it matters
Introduces MLIP Detective, an agentic physics-informed hypothesis-generation-and-screening framework that autonomously discovers hidden u-MLIP failure modes beyond fixed benchmarks, surfacing a novel MACE-MPA-0 adsorption
