...
## Why it matters
Introduces MLIP Detective, an agentic, physics-informed hypothesis-generation-and-escalation framework that autonomously uncovers hidden u-MLIP failure modes beyond fixed benchmark metrics, exemplified by a MACE-MPA-0
