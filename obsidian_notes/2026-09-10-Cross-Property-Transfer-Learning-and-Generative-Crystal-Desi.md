...
## Why it matters
Combines ALIGNN-based κL prediction with cross-property transfer learning from energy-based auxiliary tasks and CrystaLLM-generated structures to discover novel low-thermal-conductivity crystals beyond existing databases.
