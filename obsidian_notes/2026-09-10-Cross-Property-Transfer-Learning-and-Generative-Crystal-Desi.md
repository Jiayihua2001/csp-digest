...
## Why it matters
Combines ALIGNN-based κL prediction with cross-property transfer learning from energy-based tasks and CrystaLLM generative sampling to discover novel low-thermal-conductivity crystals beyond existing databases.
