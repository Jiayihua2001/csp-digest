...
## Why it matters
Combines cross-property transfer learning (energy-based source tasks) with GNN benchmarking (ALIGNN best) and CrystaLLM-generated structures to accelerate low-κL thermoelectric material discovery beyond existing databases.
