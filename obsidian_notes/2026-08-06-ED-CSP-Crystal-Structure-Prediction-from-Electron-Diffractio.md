...
## Why it matters
Introduces ED-CSP, combining a permutation-invariant multi-view ED spot encoder with a periodic flow-based generator, plus the 4.85M-structure ED-CS dataset, to directly predict crystal structures from unindexed electron diffraction, surpassing
