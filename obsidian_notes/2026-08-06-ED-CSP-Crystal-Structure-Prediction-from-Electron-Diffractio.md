...
## Why it matters
ED-CSP introduces a permutation-invariant relational encoder with periodic flow generation to directly predict full crystal structures from raw, unindexed multi-view electron diffraction spots, paired with a new 4.85M-structure simulated ED dataset, surpassing PX
