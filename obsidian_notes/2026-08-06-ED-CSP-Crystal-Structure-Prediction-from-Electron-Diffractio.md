...
## Why it matters
ED-CSP introduces a relational set-encoder plus periodic flow generator that directly predicts crystal structures from unindexed multi-view electron diffraction spots and composition, trained on a new 4.85M-structure simulated ED dataset, outperforming PXRD-based
