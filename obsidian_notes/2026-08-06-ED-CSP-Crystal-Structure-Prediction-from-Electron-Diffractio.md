...
## Why it matters
ED-CSP introduces a periodic flow-based generator with permutation-invariant multi-view ED encoding to directly predict full crystal structures from unindexed diffraction spots, backed by a new 4.85M-structure simulated ED dataset.
