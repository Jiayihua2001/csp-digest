...
## Why it matters
ED-CSP introduces a permutation-invariant multi-view ED encoder coupled with a periodic flow generator to directly predict lattice and coordinates from unindexed diffraction spots, paired with a new 4.85M-structure ED-CS dataset, outperforming P
