...
## Why it matters
Introduces uFlowCSP, a MeanFlow-based CSP model with a symmetry-aware Transformer that predicts full crystal structures in 1–5 steps, achieving 5–58× faster inference than diffusion/flow baselines with equal or better accuracy.
