...
## Why it matters
uFlowCSP applies MeanFlow to learn average probability-flow velocity for one-to-five-step crystal structure generation, achieving 5–58x faster inference than diffusion/flow baselines with equal or better accuracy.
