...
## Why it matters
Introduces uFlowCSP, a MeanFlow-based crystal structure predictor that generates full structures in 1–5 network evaluations—5x–58x faster than diffusion/flow baselines with equal or better accuracy.
