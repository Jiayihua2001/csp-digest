...
## Why it matters
Applies MeanFlow to learn average probability-flow velocity, enabling one-to-five-step crystal structure generation that matches or beats diffusion/flow baselines with 5x–100x fewer evaluations.
