...
## Why it matters
Introduces SymMC-Flow, showing absolute molecular orientation is fundamentally unlearnable due to gauge-arbitrary free rotation, while re-gauging to isolate space-group-determined relative rotations enables 13.7% exact packing reconstruction versus
