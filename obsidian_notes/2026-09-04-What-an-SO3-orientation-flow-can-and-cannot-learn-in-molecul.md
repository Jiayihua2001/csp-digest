...
## Why it matters
Introduces SymMC-Flow, a space-group-conditioned rigid-body flow on lattice×T³×SO(3), diagnostically showing absolute molecular orientation is unlearnable but re-gauged relative orientation is, enabling exact multi-copy packing re
