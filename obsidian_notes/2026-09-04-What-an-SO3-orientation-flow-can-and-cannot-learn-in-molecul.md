...
## Why it matters
Introducing SymMC-Flow, a space-group-conditioned rigid-body flow diagnosing that absolute molecular orientation is unlearnable due to gauge freedom, while re-gauging to isolate the space-group-determined relative rotation enables exact packing reconst
