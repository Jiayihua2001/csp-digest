...
## Why it matters
Introducing SymMC-Flow, a space-group-conditioned rigid-body flow that isolates gauge-arbitrary free orientation from learnable relative rotation, showing only the latter is learnable and boosting exact packing reconstruction from 0% to 13.7%.
