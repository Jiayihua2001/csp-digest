...
## Why it matters
Introduces SymMC-Flow, a space-group-conditioned rigid-body SO(3)/T3/lattice flow, revealing that only the symmetry-determined relative orientation—not the gauge-arbitrary absolute one—is learnable, boosting exact packing re
