...
## Why it matters
Introducing SymMC-Flow, a space-group-conditioned rigid-body flow that isolates a learnable relative-orientation gauge from the unlearnable free orientation, boosting exact multi-copy packing reconstruction from 0% to 13.7%.
