...
## Why it matters
Introducing SymMC-Flow, a space-group-conditioned rigid-body flow, to show absolute molecular orientation is unlearnable but re-gauging to relative symmetry-copy rotations lifts exact-match reconstruction from 0% to 13.7%.
