...
## Why it matters
Introducing SymMC-Flow, a space-group-conditioned rigid-body flow diagnosing that absolute molecular orientation is unlearnable, while re-gauging to isolate symmetry-determined relative rotations enables exact reconstruction of 13.7% of held
