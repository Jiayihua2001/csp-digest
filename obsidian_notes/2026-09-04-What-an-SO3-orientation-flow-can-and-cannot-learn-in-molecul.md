...
## Why it matters
Introduces SymMC-Flow, a space-group-conditioned rigid-body flow, revealing that absolute molecular orientation is unlearnable while re-gauged relative orientation reconstructs 13.7% of packings exactly.
