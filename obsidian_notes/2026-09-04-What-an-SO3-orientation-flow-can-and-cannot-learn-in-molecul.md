...
## Why it matters
Introducing SymMC-Flow, a space-group-conditioned rigid-body flow, they show absolute per-molecule orientation is unlearnable while re-gauging to isolate the symmetry-determined relative rotation enables 13.7% exact packing reconstruction versus
