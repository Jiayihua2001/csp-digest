...
## Why it matters
Introducing SymMC-Flow, a space-group-conditioned rigid-body flow revealing that molecular-crystal orientation prediction fails absolutely but succeeds after re-gauging to isolate the learnable symmetry-determined relative rotation.
