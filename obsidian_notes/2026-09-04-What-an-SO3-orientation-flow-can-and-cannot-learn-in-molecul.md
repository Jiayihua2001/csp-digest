...
## Why it matters
Introducing SymMC-Flow, a space-group-conditioned rigid-body flow, revealing molecular orientation splits into a learnable relative rotation and an unlearnable gauge-arbitrary component, with re-gauging enabling 13.7% exact packing reconst
