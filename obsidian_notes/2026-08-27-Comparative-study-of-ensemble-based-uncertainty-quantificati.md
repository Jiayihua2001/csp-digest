...
## Why it matters
Systematically benchmarks ensemble-based uncertainty quantification methods (bootstrap, dropout, random init, snapshot) for neural network interatomic potentials, evaluating precision-accuracy correlation for both atomic and system-level properties across ID and OOD regim
