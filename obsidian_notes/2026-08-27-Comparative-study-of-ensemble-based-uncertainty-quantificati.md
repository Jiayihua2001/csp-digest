...
## Why it matters
Systematically benchmarks four ensemble-based uncertainty quantification strategies (bootstrap, dropout, random-init, snapshot) for neural network interatomic potentials, testing precision–accuracy correlation across ID and OOD regimes and system-level observables.
