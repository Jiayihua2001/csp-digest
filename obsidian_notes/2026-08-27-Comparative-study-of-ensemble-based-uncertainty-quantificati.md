...
## Why it matters
Benchmarks four ensemble-based uncertainty quantification strategies (bootstrap, dropout, random-initialization, snapshot) for neural network interatomic potentials, systematically testing precision–accuracy correlation for both pointwise and system-level, in- and out-of
