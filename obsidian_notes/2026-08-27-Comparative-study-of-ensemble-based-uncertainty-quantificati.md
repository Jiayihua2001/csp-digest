...
## Why it matters
Systematically benchmarks four ensemble-based uncertainty quantification strategies (bootstrap, dropout, random initialization, snapshot) for neural network interatomic potentials, testing precision–accuracy correlation across in- and out-of-distribution regimes at both atom
