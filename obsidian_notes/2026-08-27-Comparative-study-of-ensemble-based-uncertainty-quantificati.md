...
## Why it matters
Systematically benchmarks four ensemble-based uncertainty quantification strategies (bootstrap, dropout, random init, snapshot) for neural network interatomic potentials, evaluating precision-accuracy correlation across ID/OOD regimes and system-level properties, not
