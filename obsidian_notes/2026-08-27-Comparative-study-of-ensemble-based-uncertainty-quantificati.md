...
## Why it matters
Systematically benchmarks four ensemble-based uncertainty quantification methods (bootstrap, dropout, random initialization, snapshot) for neural network interatomic potentials, testing whether precision predicts accuracy across ID and OOD regimes for system-level, not just force
