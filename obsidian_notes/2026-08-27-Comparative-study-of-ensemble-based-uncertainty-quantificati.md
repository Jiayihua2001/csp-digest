...
## Why it matters
Systematically compares four ensemble-based UQ methods (bootstrap, dropout, random-init, snapshot) for neural network interatomic potentials, evaluating precision-accuracy correlation across both in-distribution and out-of-distribution regimes.
