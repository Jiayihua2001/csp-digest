...
## Why it matters
Systematically benchmarks four ensemble-based UQ methods (bootstrap, dropout, random-init, snapshot) for neural network interatomic potentials, testing precision-accuracy correlation for system-level, not just force/energy, predictions in ID and OOD regimes
