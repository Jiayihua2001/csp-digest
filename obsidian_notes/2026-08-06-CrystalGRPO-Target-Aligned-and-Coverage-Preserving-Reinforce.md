...
## Why it matters
CrystalGRPO extends GRPO-style RL to joint coordinate–lattice flow policies, combining MACE energy with StructureMatcher recovery scores and a coverage-aware group advantage to preserve Top-N diversity while improving RMSE.
