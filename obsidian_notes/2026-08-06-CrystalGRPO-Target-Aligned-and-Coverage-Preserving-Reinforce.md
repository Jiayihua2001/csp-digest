...
## Why it matters
CrystalGRPO extends ODE-to-SDE reinforcement learning to joint coordinate–lattice policies, combining energy with StructureMatcher recovery rewards and coverage-aware group advantages to preserve Top-N diversity while improving flow-based CSP
