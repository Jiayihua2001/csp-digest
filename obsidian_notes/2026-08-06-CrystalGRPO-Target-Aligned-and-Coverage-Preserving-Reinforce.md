...
## Why it matters
CrystalGRPO extends ODE-to-SDE reinforcement-learning post-training to joint coordinate-lattice policies, combining MACE energy with StructureMatcher recovery reward and coverage-aware group advantage to improve Top-N crystal structure recovery
