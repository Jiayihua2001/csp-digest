...
## Why it matters
CrystalGRPO extends GRPO-style RL to joint coordinate–lattice flow policies, adding a StructureMatcher-based recovery reward and coverage-aware group advantage to preserve Top-N diversity while cutting RMSE across backbones.
