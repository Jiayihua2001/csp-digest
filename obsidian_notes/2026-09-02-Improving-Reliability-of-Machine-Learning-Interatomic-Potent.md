...
## Why it matters
Introduces a pretraining–finetuning pipeline that pretrains MLIPs on cheap empirical (EAM) potential data before finetuning on quantum data, improving MD stability and accuracy across three architectures.
