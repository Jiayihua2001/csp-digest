...
## Why it matters
AdaptNTK introduces a single-model, redundancy-aware active learning uncertainty measure using regularized Mahalanobis distance in empirical neural tangent kernel space, enabling recursive batch updates without retraining or ensembling.
