...
## Why it matters
Introduces AdaptNTK, a single-model uncertainty measure using regularized Mahalanobis distance in empirical neural tangent kernel space, enabling label-free recursive batch updates that reduce redundancy without retraining or ensembles.
