...
## Why it matters
AdaptNTK introduces a single-model, label-free uncertainty measure—regularized Mahalanobis distance in fixed empirical neural tangent kernel feature space—enabling recursive, retraining-free batch updates that reduce redundancy versus ensemble-based active
