...
## Why it matters
AdaptNTK introduces a single-model, retraining-free active-learning uncertainty measure—regularized Mahalanobis distance in empirical NTK feature space—updated recursively to reduce batch redundancy, matching ensemble-level force-error correlation on rMD17
