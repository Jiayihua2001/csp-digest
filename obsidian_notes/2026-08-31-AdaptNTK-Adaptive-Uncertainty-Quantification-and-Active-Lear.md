...
## Why it matters
AdaptNTK introduces a single-model, retraining-free active-learning framework using recursively updatable Mahalanobis distance in empirical neural tangent kernel space to reduce batch redundancy while matching ensemble-level uncertainty quality.
