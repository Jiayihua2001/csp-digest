...
## Why it matters
AdaptNTK introduces a single-model, label-free uncertainty measure via regularized Mahalanobis distance in empirical neural tangent kernel space, enabling recursive, redundancy-aware batch active learning without retraining or ensembling.
