...
## Why it matters
AdaptNTK introduces a single-model, label-free Mahalanobis-distance uncertainty in empirical neural-tangent-kernel feature space that updates recursively during batch acquisition, cutting redundancy without retraining or ensembling.
