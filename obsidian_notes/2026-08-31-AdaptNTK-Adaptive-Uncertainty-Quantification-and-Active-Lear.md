...
## Why it matters
AdaptNTK introduces a single-model, retraining-free uncertainty measure—regularized Mahalanobis distance in empirical neural tangent kernel space, recursively updatable per selection—to reduce batch redundancy in active learning for interatomic potentials.
