...
## Why it matters
AdaptNTK introduces a single-model uncertainty quantifier using regularized Mahalanobis distance in fixed empirical neural tangent kernel feature space, enabling recursive, retraining-free batch updates that reduce redundancy in active learning for neural network potentials
