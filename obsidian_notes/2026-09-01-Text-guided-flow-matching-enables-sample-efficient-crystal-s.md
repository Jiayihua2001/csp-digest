...
## Why it matters
TFMat introduces text-conditioned flow matching—using structured materials language as a semantic prior—to steer CrystalFlow generation, boosting match rates and property alignment over unconditioned baselines.
