...
## Why it matters
TFMat couples structured materials-language text embeddings with a CrystalFlow flow-matching generator, boosting CSP match rates (92.04% MP-20 at 20 candidates) and improving de novo distribution alignment.
