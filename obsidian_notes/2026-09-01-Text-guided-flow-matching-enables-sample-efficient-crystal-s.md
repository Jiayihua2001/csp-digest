...
## Why it matters
TFMat introduces text-conditioned flow matching—using structured materials language as a semantic prior over CrystalFlow—boosting sample-efficient CSP match rates (92.04% MP-20 with 20 candidates) versus unconditioned baselines.
