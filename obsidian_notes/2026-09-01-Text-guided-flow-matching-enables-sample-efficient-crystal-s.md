...
## Why it matters
TFMat introduces text-conditioned flow matching—using structured materials-language priors to steer CrystalFlow generation—boosting MP-20 match rates and de novo property alignment versus unconditioned baselines.
