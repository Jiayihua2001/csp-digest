...
## Why it matters
TFMat introduces text-conditioned flow matching—using structured materials-language priors to guide CrystalFlow—achieving higher match rates and better sample efficiency on Perov-5, Carbon-24, and MP-20 benchmarks.
