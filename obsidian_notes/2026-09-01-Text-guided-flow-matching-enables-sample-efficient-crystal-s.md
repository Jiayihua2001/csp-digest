...
## Why it matters
TFMat introduces structured-text conditioning as a semantic prior atop CrystalFlow's flow-matching generator, boosting sample-efficient CSP match rates (92.04% on MP-20 with 20 candidates) and de novo property alignment.
