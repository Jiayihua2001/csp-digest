...
## Why it matters
Introduces a budget-resolved comparison showing coverage- versus disagreement-based ("response witness") training-set selection for MLIPs cross over in effectiveness as retained data fraction increases.
