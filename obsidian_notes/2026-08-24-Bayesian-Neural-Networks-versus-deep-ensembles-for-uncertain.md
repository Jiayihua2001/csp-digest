...
## Why it matters
Implements variational-inference Bayesian neural networks in the aenet-PyTorch framework and benchmarks their uncertainty quantification against deep ensembles for interatomic potentials on TiO2 and QM7 datasets.
