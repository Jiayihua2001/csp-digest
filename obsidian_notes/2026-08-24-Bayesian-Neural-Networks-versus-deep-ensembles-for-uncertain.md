...
## Why it matters
Implements variational-inference Bayesian neural networks in the æne­t-PyTorch framework and systematically benchmarks them against deep ensembles for uncertainty quantification in interatomic potentials on TiO2 and QM7 datasets.
