...
## Why it matters
Introduces a variational Bayesian neural network implementation within the æ net-PyTorch framework, benchmarking it against deep ensembles for uncertainty quantification on TiO2 and QM7 datasets.
