...
## Why it matters
Introduces a variational-inference Bayesian neural network implementation in aenet-PyTorch and benchmarks it against deep ensembles for interatomic potential uncertainty on TiO2 and QM7 datasets.
