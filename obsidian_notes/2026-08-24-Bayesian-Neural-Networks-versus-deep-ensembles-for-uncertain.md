...
## Why it matters
Implements variational-inference Bayesian neural networks in the ænet-PyTorch framework and benchmarks them against deep ensembles for uncertainty quantification on TiO2 and QM7 interatomic-potential datasets.
