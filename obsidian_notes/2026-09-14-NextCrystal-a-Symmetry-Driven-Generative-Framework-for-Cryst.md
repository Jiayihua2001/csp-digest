...
## Why it matters
NextCrystal introduces a language-model-driven, template-free generator that directly predicts fine-grained Wyckoff site patterns via linear-complexity beam search, then guides a diffusion backbone for symmetry-consistent crystal structure prediction.
