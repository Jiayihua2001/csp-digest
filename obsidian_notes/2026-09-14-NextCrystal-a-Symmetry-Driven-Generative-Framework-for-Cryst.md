...
## Why it matters
Introduces NextCrystal, using a language model with linear-complexity heuristic beam search to generate template-free, stoichiometry-consistent Wyckoff site patterns guiding a diffusion-based crystal structure predictor.
