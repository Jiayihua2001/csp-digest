...
## Why it matters
Introduces NextCrystal, which uses language models to directly generate template-free Wyckoff site patterns via linear-complexity beam search, enforcing symmetry consistency within a diffusion-based CSP backbone.
