...
## Why it matters
NextCrystal introduces a language-model-driven, template-free generator that directly predicts fine-grained Wyckoff site patterns via a linear-complexity heuristic beam search, enforcing symmetry consistency within a diffusion-based CSP pipeline.
