...
## Why it matters
NextCrystal introduces a language-model-driven, template-free generator of fine-grained Wyckoff site patterns coupled with a linear-complexity heuristic beam search enforcing multiplicity–stoichiometry consistency, guiding a diffusion backbone for symm
