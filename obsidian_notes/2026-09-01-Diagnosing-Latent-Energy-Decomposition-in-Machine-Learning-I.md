...
## Why it matters
Introduces E3D-IQA, a diagnostic framework pairing Allegro-type MLIP edge/node energy channels with IQA decomposition, showing intra-atomic supervision is required to recover physically meaningful one-/two-body energy allocation.
