...
## Why it matters
Introduces E3D-IQA, a diagnostic framework pairing Allegro-type MLIP edge/node energies with IQA decomposition, showing intra-atomic supervision—not just energy/force training—is needed for physically meaningful one-/two-body energy allocation.
