...
## Why it matters
Introduces E3D-IQA, a diagnostic framework pairing Allegro-type MLIP edge/node energy channels with IQA decomposition to expose hidden one-body/two-body energy-allocation errors invisible to standard energy/force metrics.
