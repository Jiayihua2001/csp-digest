...
## Why it matters
Introduces E3D-IQA, a diagnostic framework supervising Allegro-type MLIP node energies with IQA intra-atomic terms to expose hidden failures in latent edge-energy pair allocation invisible to standard energy/force metrics.
