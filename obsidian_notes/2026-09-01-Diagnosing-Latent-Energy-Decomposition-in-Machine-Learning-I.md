...
## Why it matters
Introduces E3D-IQA, a diagnostic framework supervising an Allegro-type MLIP's node energies with IQA intra-atomic terms to expose hidden one-body/two-body energy-allocation failures invisible to standard energy/force metrics.
