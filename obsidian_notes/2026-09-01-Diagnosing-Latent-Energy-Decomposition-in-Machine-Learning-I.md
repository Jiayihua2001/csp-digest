...
## Why it matters
E3D-IQA introduces a diagnostic framework that supervises Allegro-type MLIP node energies with IQA intra-atomic terms, exposing hidden one-body/two-body energy-allocation errors invisible to standard energy/force metrics.
