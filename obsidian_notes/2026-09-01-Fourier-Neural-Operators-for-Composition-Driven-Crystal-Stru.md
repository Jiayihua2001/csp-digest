...
## Why it matters
Introduces a Fourier Neural Operator-based crystal-field solver capturing global periodic correlations, coupled with a conditional VAE and reconstruction pipeline for composition-driven crystal structure generation.
