...
## Why it matters
Introduces a Fourier Neural Operator crystal-field solver—replacing local 3D-CNN/VAE voxel models—that predicts global periodic density fields from composition and lattice parameters for structure generation.
