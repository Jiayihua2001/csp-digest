...
## Why it matters
Introduces a Fourier Neural Operator-based crystal-field solver, coupled with a low-dimensional cVAE lattice generator, to predict periodic density fields and reconstruct atomic structures, capturing long-range correlations beyond CNN-based voxel methods.
