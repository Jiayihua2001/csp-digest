...
## Why it matters
Introduces a Fourier Neural Operator crystal-field solver—capturing global periodic correlations beyond local 3D-CNNs—coupled with a conditional VAE and peak-detection reconstruction pipeline for composition-driven structure generation.
