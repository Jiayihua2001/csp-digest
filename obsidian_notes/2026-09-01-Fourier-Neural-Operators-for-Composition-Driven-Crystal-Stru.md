...
## Why it matters
Introduces a Fourier Neural Operator-based crystal-field solver capturing global periodic correlations, coupled with a conditional VAE generator and peak-detection reconstruction pipeline for composition-driven structure discovery.
