...
## Why it matters
Introduces a Fourier Neural Operator-based crystal-field solver coupled with a low-dimensional conditional VAE lattice generator, replacing voxel-CNN/VAE approaches to capture long-range periodic correlations for composition-conditioned crystal structure disc
