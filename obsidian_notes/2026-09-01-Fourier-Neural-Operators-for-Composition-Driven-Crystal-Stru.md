...
## Why it matters
Introduces a Fourier Neural Operator-based crystal-field solver, replacing local 3D-CNN/VAE voxel models, coupled with a conditional VAE lattice generator and peak-detection-based atomic reconstruction for composition-driven CSP.
