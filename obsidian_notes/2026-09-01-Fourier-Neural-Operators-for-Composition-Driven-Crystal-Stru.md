...
## Why it matters
Introduces a Fourier Neural Operator-based crystal-field solver, coupled with a low-dimensional conditional VAE, to predict periodic density fields and reconstruct atomic structures directly from composition and lattice parameters.
