...
## Why it matters
Introduces a Fourier Neural Operator-based crystal-field solver capturing global periodic correlations, coupled with a conditional VAE lattice generator for composition-to-structure crystal discovery beyond local voxel/CNN methods.
