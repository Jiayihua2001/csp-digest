...
## Why it matters
Introduces a Fourier Neural Operator crystal-field solver—capturing long-range periodic correlations beyond local 3D-CNNs—coupled with a low-dimensional cVAE for composition-driven structure generation and reconstruction.
