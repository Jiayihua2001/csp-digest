...
## Why it matters
Introduces a Fourier Neural Operator-based crystal-field solver that predicts periodic density fields directly from composition and lattice parameters, replacing local 3D-CNN/VAE voxel methods with global spectral modeling for structure generation and reconstruction.
